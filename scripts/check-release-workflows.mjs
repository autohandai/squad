...
assertIncludes(releaseWorkflow, 'name: Import Apple signing certificate', 'Release workflow imports the Apple signing certificate when configured');
assertIncludes(releaseWorkflow, 'name: Import Windows signing certificate', 'Release workflow imports the Windows signing certificate when configured');
